  ...
  return (
    ...
    <Typography className="container hero"style={{marginRight:"900px"}}>
      <Typography className="hero-text" style={{marginTop:"200px",}}>
        <Typography variant="h2">Inventory and Stock Management Solution</Typography>
...
const NumberText: React.FC<NumberTextProps> = ({ num, text }) => {
  return (
    <Typography className='--mr'>
      <Typography variant="h3" className='--color-#030b6b'>{num}</Typography>
      <Typography variant="h3" className='--color-#030b6b'>{text}</Typography>
    </Typography>
  );
};
